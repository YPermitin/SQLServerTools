...
* [Копия базы 1С для отчетов. Как работать с репликой только для чтения](https://infostart.ru/1c/articles/1283828/) - использование "read-only" реплик для платформы 1С.
