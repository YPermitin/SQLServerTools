...
Для создания распределенной группы доступности понадобиться настроить прослушиватель для локальной группы.
...
По истине мощный механизм масштабирования и отказоустойчивости умелых руках!
